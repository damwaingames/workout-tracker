...
| `verify-progression` | **Pure-Node** (no browser): the #46 maths + queries — rail→zone threading (floor label + spanned set), the double-progression target across kg / band / bodyweight and at the rail cap, Epley guide-ghost seeding, the e1RM trend, and the ghost / target / guide / load-carries-across-a-rail-change behaviour over a real timeline |
